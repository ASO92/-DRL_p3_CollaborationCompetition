...
To see the steps on how is trained the agent it is recommended to explore the [Tennis.ipynb](./DRL_p3_CollaborationCompetition/Tennis.ipynb) file and follow the isntructions on it.
