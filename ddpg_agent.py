...
class Agent():
    ...
    def __init__(
        ...
        memory=None,            # Variable to introduce memory of the other agent, None
        ...
        # Replay memory
        if not isinstance(memory, ReplayBuffer): # In case that memory property is None (first agent introduced).
